#!/bin/bash
# Train all 4 algorithms sequentially using OCAtari
# Usage: bash new_train_all.sh

echo "=========================================="
echo "Training All Algorithms for MsPacman (OCAtari)"
echo "=========================================="
echo ""
...
echo "  python new_play_all.py --compare -e 10"
echo ""
