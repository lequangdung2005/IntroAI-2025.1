"""
Train an A2C agent to play Pacman using Stable Baselines3
...
def train_a2c():
    """Train the A2C agent"""
    print("=" * 60)
    print("Training A2C Agent for Pacman")
    print("=" * 60)
    ...
    # Save final model
    final_model_path = "models/a2c/pacman_a2c_final.zip"
